...
| Сервис | Технология | Домен | Данные | Порт |
|--------|-----------|-------|--------|------|
| **User Service** | Go | Пользователи, аутентификация, профили | `users` | 8083 |
| **Billing Service** | Go | Платежи, подписки, тарифные планы, скидки | `payments`, `subscriptions` | 8084 |
| **Content Service** | Go | Просмотры, прогресс воспроизведения, стриминг | `views` | 8085 |
| **Movies Service** | Go | Метаданные фильмов, жанры, рейтинги, оценки | `movies`, `movie_genres`, `user_ratings` | 8081 |
| **Events Service** | Node.js | Kafka producer/consumer, шина событий | — | 8082 |
| **Proxy Service** | Node.js | API Gateway, маршрутизация | — | 8000 |
...
- **Content Service** — отвечает за доставку и потребление контента: история просмотров, прогресс воспроизведения (где пользователь остановился), взаимодействие с S3 (хранение видео) и внешними онлайн-кинотеатрами (агрегация).
